...
export const processList8 = [
  {
    ...
    description:
      "You can download the Skoop extension from Chrome webstore. Download Link",
  },
  {
    id: 2,
    Icon: Savings,
    ...
    className: "d-flex flex-row mb-5",
    description:
      "You can signup using Social login (Google/LinkedIn) Or you can signup with your email.",
  },
  {
    id: 3,
    Icon: Loading,
    iconColor: "red",
    title: "Choose a Plan and enjoy Skoop app",
    className: "d-flex flex-row",
    description:
      "Choose a suitable plan, Make the payment through our secure payment method and enjoy Skoop app",
  },
];
